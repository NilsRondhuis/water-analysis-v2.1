...
refs.inputPromocode.addEventListener("focus", onFocusInputPromocode);
refs.inputPromocode.addEventListener("blur", onNotFocusInputPromocode);
...
function onFocusInputPromocode(e) {
  e.currentTarget.classList.add("form__input--color-is-focus");
}
function onNotFocusInputPromocode(e) {
  e.currentTarget.classList.remove("form__input--color-is-focus");
}
